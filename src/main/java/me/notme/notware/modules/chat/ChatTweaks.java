package me.notme.notware.modules.chat;

import me.notme.notware.NotWare;
import me.notme.notware.utils.chat.Emotes;
...
public class ChatTweaks extends Module {
    ...
    public ChatTweaks() {
        super(NotWare.nwmisc, "better-chat-plus", "Various chat improvements.");
    }
    ...
    public void onActivate() {
        ChatUtils.registerCustomPrefix("me.notme.notware", this::getPrefix);
    }
