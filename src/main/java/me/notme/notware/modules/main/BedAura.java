...
import me.notme.notware.utils.world.BlockHelper;
import me.notme.notware.utils.player.AutomationUtils;
import me.notme.notware.utils.player.BedUtils;
import me.notme.notware.utils.player.ItemHelper;
...
public class BedAura extends Module {
    ...
    private final Setting<Boolean> oneDirection = sgGeneral.add(new BoolSetting.Builder().name("one-direction-only").description("Only places beds in the direction you are facing.").defaultValue(false).build());
    ...
    public int timer;
    public static int webTimer;
    private Item ogItem;
    private boolean sentTrapMine, sentBurrowMine, safetyToggled;


    public BedAura() {
        super(NotWare.nwcombat, "bed-aura-plus", "big trolle");
    }
