...
public class NotifierPlus extends Module {
    ...
    private final Setting<Boolean> helmet = sgArmor.add(new BoolSetting.Builder()
        .name("helmet")
        .description("Ignores fake players.")
        .defaultValue(true)
        .build()
    ...
    private final Setting<Integer> helmettwo = sgArmor.add(new IntSetting.Builder()
        .name("durability")
    ...
    private final Setting<Boolean> chestplate = sgArmor.add(new BoolSetting.Builder()
        .name("chestplate")
        .description("Ignores fake players.")
        .defaultValue(true)
        .build()
    ...
    private final Setting<Integer> chestplatetwo = sgArmor.add(new IntSetting.Builder()
        .name("durability")
        .description("Takes off armor if it is about to break.")
        .defaultValue(40)
        .min(0)
        .sliderMax(50)
        .max(592)
        .visible(chestplate::get)
        .build()
    );

    private final Setting<Boolean> leggings = sgArmor.add(new BoolSetting.Builder()
        .name("leggings")
        .description("Ignores fake players.")
        .defaultValue(true)
        .build()
    ...
    private final Setting<Integer> leggingstwo = sgArmor .add(new IntSetting.Builder()
        .name("durability")
        .description("Takes off armor if it is about to break.")
        .defaultValue(40)
        .min(0)
        .sliderMax(50)
        .max(555)
        .visible(leggings::get)
        .build()
    );

    private final Setting<Boolean> boots = sgArmor.add(new BoolSetting.Builder()
        .name("boots")
        .description("Ignores fake players.")
        .defaultValue(true)
        .build()
    ...
    private final Setting<Integer> bootstwo = sgArmor.add(new IntSetting.Builder()
        .name("durability")
        .description("Takes off armor if it is about to break.")
        .defaultValue(40)
        .min(0)
    ...
    public NotifierPlus() {
        super(NotWare.nwmisc, "notifier-plus", "Notifies you of different events.");
    }
    ...
    private void onTick(TickEvent.Post event) {
        ...
        for (int i = 0; i < mc.player.getInventory().main.size(); i++) {
            ...
            if (helmet.get() && itemStack.isDamageable() && itemStack.getMaxDamage() - itemStack.getDamage() <= helmettwo.get()) {
                info("Your §fhelmet §7is almost broken");
            }
            if (chestplate.get() && itemStack.isDamageable() && itemStack.getMaxDamage() - itemStack.getDamage() <= chestplatetwo.get()) {
                info("Your §fchestplate §7is almost broken");
            }
            if (leggings.get() && itemStack.isDamageable() && itemStack.getMaxDamage() - itemStack.getDamage() <= leggingstwo.get()) {
                info("Your §fleggings §7are almost broken");
            }
            if (boots.get() && itemStack.isDamageable() && itemStack.getMaxDamage() - itemStack.getDamage() <= bootstwo.get()) {
                info("Your §fboots §7are almost broken");
            }
        }
    }
