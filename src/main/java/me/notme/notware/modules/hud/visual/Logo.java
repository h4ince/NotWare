...
public class Logo extends HudElement {
    private static final Identifier LOGO = new Identifier("notware", "logo.png");
    private static final Identifier LOGO_FLAT = new Identifier("notware", "logo_flat.png");
    ...
    public Logo(HUD hud) {
        super(hud, "Notware-logo", "Displays the Notware logo.");
    }
